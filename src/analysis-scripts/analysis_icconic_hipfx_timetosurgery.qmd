...
write.table(variables_in_hospital,'../../outputs/table_descriptive_hospital_with_unique_patients.csv',row.names = FALSE, sep='|', na='',fileEncoding="UTF-8")
table
rm(table)
```
...
filter_hospital_by_npatients <- function(n_filter, variables_in_hospital, df_model,
                                         n_min_hospital,n_max_hospital, perc_sample){
...
df_model_filter <- filter_hospital_by_npatients(n_filter=50,variables_in_hospital,df_model,n_min_hospital=5, 
                                                n_max_hospital=150, perc_sample=85)
df_model_filter <- na.omit(df_model_filter)

log_info(paste0("For multilevel model, the number of records is: ",nrow(df_model_filter),' which is a percentage of the sample of: ',round(100*(nrow(df_model_filter)/sum(variables_in_hospital$n_hospitalization_episode_id, na.rm = TRUE)),2),'%'))
...
write.table(output_model_exitus_hospital_bl,'../../outputs/aggregated_outputs_byhospital_GAMM_exitus_inhospital.csv', sep='|',row.names=FALSE,na='',fileEncoding="UTF-8")
...
write.table(output_model_exitus_7days_bl,'../../outputs/aggregated_outputs_byhospital_GAMM_exitus_in7days.csv', sep='|',row.names=FALSE,na='',fileEncoding="UTF-8")
...
write.table(output_model_exitus_30days_bl,'../../outputs/aggregated_outputs_byhospital_GAMM_exitus_in30days.csv', sep='|',row.names=FALSE,na='',fileEncoding="UTF-8")
...
p
write.table(p,'../../outputs/performance_GAMM_exitus.csv', sep='|',row.names=FALSE,na='',fileEncoding="UTF-8")
```
...
write.table(output_model_unplanned_7days_bl,'../../outputs/aggregated_outputs_byhospital_GAMM_unplanned_7days.csv', sep='|',row.names=FALSE)
...
write.table(output_model_unplanned_30days_bl,'../../outputs/aggregated_outputs_byhospital_GAMM_unplanned_30days.csv', sep='|',row.names=FALSE)
...
p
write.table(p,'../../outputs/performance_GAMM_unplanned_readmission.csv', sep='|',row.names=FALSE,na='',fileEncoding="UTF-8")
```
