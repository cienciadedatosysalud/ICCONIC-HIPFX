...
p <- compare_performance(model_exitus_7days_bl, model_exitus_30days_bl)

p$Name[p$Name %in% 'model_exitus_7days_bl'] <- 'Model 1: exitus in 7 days after surgery'
p$Name[p$Name %in% 'model_exitus_30days_bl'] <- 'Model 2: exitus in 30 days after surgery'
