...
####(Updates)####
Drug_class_desc = pd.DataFrame({
'Drug_Category' : ['Aldehydes', 'Alkylamines', 'Aminoalkyl Ethers', 'Antacids', 'Anticholinergic Agents', 'Azaspirodecanediones', 'Barbiturates', 'Barbiturates', 'Benzodiazepines', 'Benzodiazepines', 'Benzodiazepines', 'Butyrophenones', 'Carbamates', 'Carboxamides', 'Centrally-Acting Antihypertensives', 'Dibenzoxazepines', 'Dibenzoxazepines', 'Diphenylbutylpiperidines', 'Dopaminergic Agents', 'Ethylene Diamines', 'Fatty Acid Derivatives', 'Gabapentinoids', 'H1-Receptor Antagonists', 'H2-Receptor Antagonists', 'Hydantoins', 'Indole Derivatives', 'Indole Derivatives', 'Inhaled Corticosteroids', 'Loop Diuretics', 'Melatonin-Agonists', 'Muscle Relaxers', 'Nitrates', 'Opioids', 'Opioids', 'Oral Steroids', 'Orexin Antagonists', 'Other Antiepileptics', 'Other Antihistamines', 'Other Antipsychotics', 'Other Hypnotics and Sedatives', 'Phenothiazine Derivatives', 'Phenothiazines', 'Piperazines', 'Proton Pump Inhibitors', 'SSRI - Selective Serotonin Reuptake Inhibitors', 'Sodium-glucose Co-transporter 2 Inhibitors', 'Succinimides', 'Sulfonylureas', 'Thiazides and Other Low-Ceiling Drugs', 'Thiazolidinediones', 'Thioxanthenes', 'Tricyclic Antidepressants'],
'Cate_short_name' : ['ALD', 'ALKAM', 'AAE', 'ACIDS', 'ACH', 'AZA', 'BRBT', 'BRBT', 'BZD', 'BZD', 'BZD', 'BUTY', 'CARB', 'CBX', 'CAA', 'DBZ', 'DBZ', 'DPBP', 'DOPA', 'EDIAM', 'FAD', 'GPTN', 'H1-RA', 'H2-RA', 'HYDAN', 'INDOL', 'INDOL', 'ICS', 'LPD', 'MEL', 'MUSREL', 'NIT', 'OPI', 'OPI', 'ORST', 'OREX', 'OAE', 'OAH', 'OAP', 'OHS', 'PHED', 'PHEN', 'PIP', 'PPI', 'SSRI', 'SGLT2', 'SUCC', 'SU', 'THZLC', 'TZD', 'THIOX', 'TCA'],
'Grandparent_Class' : ['hypnotics_and_sedatives', 'antihistamines', 'antihistamines', 'Acid_related_disorders', 'anti_parkinson_drugs', 'anxiolytics', 'hypnotics_and_sedatives', 'antiepileptics', 'hypnotics_and_sedatives', 'anxiolytics', 'antiepileptics', 'typical_antipsychotics', 'anxiolytics', 'antiepileptics', 'Hypertension', 'typical_antipsychotics', 'atypical_antipsychotics', 'typical_antipsychotics', 'anti_parkinson_drugs', 'antihistamines', 'antiepileptics', 'analgesics', 'anxiolytics', 'Acid_related_disorders', 'antiepileptics', 'atypical_antipsychotics', 'typical_antipsychotics', 'obstructive_airway_diseases', 'Diuretic', 'hypnotics_and_sedatives', 'musculo_skeletal_system', 'Angina_pectoris', 'anesthetics', 'analgesics', 'hormones_hormone_modifiers', 'hypnotics_and_sedatives', 'antiepileptics', 'antihistamines', 'atypical_antipsychotics', 'hypnotics_and_sedatives', 'antihistamines', 'typical_antipsychotics', 'antihistamines', 'Acid_related_disorders', 'antidepressant', 'Diabetes', 'antiepileptics', 'Diabetes', 'Diuretic', 'Diabetes', 'typical_antipsychotics', 'antidepressant'],
'Risk_Class' : ['Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Bone_mass_decrese_moderate', 'Fall_increase_moderate', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_moderate', 'Fall_increase_high', 'Fall_increase_moderate', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_moderate', 'Fall_increase_high', 'Bone_mass_decrese_moderate', 'Fall_increase_high', 'Fall_increase_moderate', 'Fall_increase_high', 'Bone_mass_decrese_moderate', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_moderate', 'Fall_increase_high', 'Fall_increase_moderate', 'Fall_increase_moderate', 'Bone_mass_decrese_high', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_moderate', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_high', 'Bone_mass_decrese_high', 'Fall_increase_moderate', 'Bone_mass_decrese_moderate', 'Fall_increase_high', 'Fall_increase_high', 'Fall_increase_moderate', 'Bone_mass_decrese_moderate', 'Fall_increase_high', 'Fall_increase_high']
                           })  ###change_0513
Drug_class_desc
```
...
Grandparent_collist = pres_1['Grandparent_Class'].unique().tolist() ###change_0505
Grandparent_collist_2 = [x + '_Pre' for x in Grandparent_collist] + [x + '_Post' for x in Grandparent_collist] ###change_0510
for col in Grandparent_collist_2: ###change_0510
    if col not in Grandparent.columns:
        Grandparent[col] = pd.NA 

Risk_collist = pres_1['Risk_Class'].unique().tolist()###change_0505
Risk_collist_2 = [x + '_Pre' for x in Risk_collist] + [x + '_Post' for x in Risk_collist] ###change_0510
for col in Risk_collist_2: ###change_0510
    if col not in Risk.columns:
        Risk[col] = pd.NA

DrugCate_collist = pres_1['Cate_short'].unique().tolist()###change_0505
DrugCate_collist_2 = [x + '_Pre' for x in DrugCate_collist] + [x + '_Post' for x in DrugCate_collist] ###change_0510
for col in DrugCate_collist_2: ###change_0510
...
DrugCate_list = DrugCate_collist###change_0505
...
Grandparent_list = Grandparent_collist###change_0505
...
Risk_list = Risk_collist###change_0505
...
###change_0505
atc_5_full = pres_0[['prescription_atc_cd']].drop_duplicates()
atc_5_desc = pres_0[['patient_id', 'pres_window_start', 'hospital_admission_dt', 'wash_out_end', 'observation_end', 'prescription_start_dt', 'prescription_atc_cd']]
atc_5_desc['Med_Time'] = None
atc_5_desc.loc[(atc_5_desc['prescription_start_dt'] >= atc_5_desc['pres_window_start']) & (atc_5_desc['prescription_start_dt'] < atc_5_desc['hospital_admission_dt']), 'Med_Time'] = 'Pre' # Falg prescription during pre admission period
atc_5_desc.loc[(atc_5_desc['prescription_start_dt'] > atc_5_desc['wash_out_end']) & (atc_5_desc['prescription_start_dt'] <= atc_5_desc['observation_end']), 'Med_Time'] = 'Post' # Flag prescription during observation period
atc_5_desc = atc_5_desc[atc_5_desc['Med_Time'].isnull() == False] 
atc_5_desc = atc_5_desc[['patient_id', 'prescription_atc_cd', 'Med_Time']].drop_duplicates().reset_index(drop=True)
atc_5_desc_agg = atc_5_desc.groupby(['patient_id', 'Med_Time']).agg({'prescription_atc_cd':'nunique'}).reset_index()
atc_5_desc_agg_wide = atc_5_desc_agg.pivot(index='patient_id', columns='Med_Time', values='prescription_atc_cd').reset_index()
atc_5_desc_agg_wide.columns = ['patient_id', 'All_Med_Count_Pre', 'All_Med_Count_Post']
hip_polypharm = hip_polypharm.merge(atc_5_desc_agg_wide, how='left', on='patient_id')
hip_polypharm.loc[(hip_polypharm['All_Med_Count_Pre'] <5) | (hip_polypharm['All_Med_Count_Pre'].isnull()), 'Burden_of_Med_Pre'] = 'Low'
hip_polypharm.loc[(hip_polypharm['All_Med_Count_Pre'] >=5) & (hip_polypharm['All_Med_Count_Pre'] <10), 'Burden_of_Med_Pre'] = 'Mid'
hip_polypharm.loc[hip_polypharm['All_Med_Count_Pre'] >=10, 'Burden_of_Med_Pre'] = 'High'

cate_short_list = (Drug_class_desc['Cate_short_name'] + '_Patterns').unique().tolist()
Grandparent_list = (Drug_class_desc['Grandparent_Class'] + '_Patterns').unique().tolist()
Risk_list = (Drug_class_desc['Risk_Class'] + '_Patterns').unique().tolist()
...
continuous_variable_list = ['age_nm', 'Length_of_stay', 'Comorbidities_Count', 'Cate_short_Count_Pre', 'Cate_short_Count_Post', 'Grandparent_Class_Count_Pre', 'Grandparent_Class_Count_Post', 'Risk_Class_Count_Pre', 'Risk_Class_Count_Post', 'All_Med_Count_Pre', 'All_Med_Count_Post'] ###change_0505
...
categorical_variable_list = ['sex_cd', 'exitus_bl', 'exitus_outcome', 'readm_washout', 'readm_observation', 'readm_outcome', 'refracture_washout', 'refracture_observation', 'refracture_outcome', 'exitus_readm_outcome', 'Burden_of_Med_Pre'] ###change_0505
...
# By Drug Category
cate_short_prepost_list = DrugCate_collist_2 ###change_0505
for cohort in cohort_list:
...
Grandparent_prepost_list = Grandparent_collist_2 ###change_0505
for cohort in cohort_list:
    id_list = globals()[cohort][['patient_id']]
...
# By Risk Class
Risk_count_prepost_list = Risk_collist_2 ###change_0505
for cohort in cohort_list:
    id_list = globals()[cohort][['patient_id']]
...
# By Drug Category
cate_short_patterns_list = DrugCate_patterns.columns.tolist()[1:][:-2] ###change_0505
for cohort in cohort_list:
...
Grandparent_patterns_list = Grandparent_patterns.columns.tolist()[1:][:-2] ###change_0505
for cohort in cohort_list:
...
# By Risk Class
Risk_patterns_list = Risk_patterns.columns.tolist()[1:][:-2] ###change_0505
for cohort in cohort_list:
...
###change_0505
def add_duration_suffix(strings):
    return [s[:s.rfind('_')] + "_Duration" + s[s.rfind('_'):] if '_' in s else s + "_Duration" for s in strings]  
###change_0505

cate_short_duration_list = add_duration_suffix(DrugCate_collist_2) ###change_0505
...
Grandparent_duration_list = add_duration_suffix(Grandparent_collist_2) ###change_0505
...
Risk_duration_list = add_duration_suffix(Risk_collist_2) ###change_0505
...
dx_full_model = dx_full[['patient_id', 'exitus_readm_outcome', 'refracture_outcome', 'age_nm', 'Length_of_stay','sex_cd', 'residence_area_cd', 'previous_hospital_admission_bl', 'hospital_admission_type_cd', 'All_Med_Count_Pre', 'All_Med_Count_Post', 'Burden_of_Med_Pre'] + cate_short_patterns_list + Grandparent_patterns_list + Risk_patterns_list] ###change_0505
...
desc_result_file_list = ['atc_5_full','desc_continuous_result_dx_combined', 'desc_categorical_result_dx_combined', 'Comorbidities_result_dx_combined', 'desc_distribution_result_combined', 'desc_drug_pattern_result_combined', 'duration_result_combined', 'duration_drug_pattern_result_combined', 'outcome_drug_pattern_result_combined'] ###change_0505
...
ps_score <- function(outcome_variable, df) {
  ...
  if (previous_adm_bl_notnull & hospital_admtype_notnull) {
    ps_model <- glm(outcome_variable ~ age_nm + sex_cd + previous_hospital_admission_bl + hospital_admission_type_cd, data = df, family = "binomial")
} else if (previous_adm_bl_notnull) {
    ps_model <- glm(outcome_variable ~ age_nm + sex_cd + previous_hospital_admission_bl, data = df, family = "binomial")
} else if (hospital_admtype_notnull) {
    ps_model <- glm(outcome_variable ~ age_nm + sex_cd + hospital_admission_type_cd, data = df, family = "binomial")
} else {
    ps_model <- glm(outcome_variable ~ age_nm + sex_cd, data = hip_poly, family = "binomial")
}
  return(ps_model)
}
...
ps_matching <- function(outcome_variable, df) {
    ...
    if (previous_adm_bl_notnull & hospital_admtype_notnull) {
    matchit_model_exitus_readm <- matchit(outcome_variable ~ age_nm + sex_cd + previous_hospital_admission_bl + hospital_admission_type_cd, data = df, method = "nearest", ratio = 1)
} else if (previous_adm_bl_notnull) {
    matchit_model_exitus_readm <- matchit(outcome_variable ~ age_nm + sex_cd + previous_hospital_admission_bl, data = df, method = "nearest", ratio = 1)
} else if (hospital_admtype_notnull) {
    matchit_model_exitus_readm <- matchit(outcome_variable ~ age_nm + sex_cd + hospital_admission_type_cd, data = df, method = "nearest", ratio = 1)
} else {
    matchit_model_exitus_readm <- matchit(outcome_variable ~ age_nm + sex_cd, data = df, method = "nearest", ratio = 1)
}
...
###change_0601
### create model strings, only select exist drug columns
cate_cols <- c('ACIDS_Patterns', 'H2_RA_Patterns', 'PPI_Patterns', 'TZD_Patterns', 'SU_Patterns', 'SGLT2_Patterns', 'NIT_Patterns', 'CAA_Patterns', 'THZLC_Patterns', 'LPD_Patterns', 'ORST_Patterns', 'MUSREL_Patterns', 'OPI_Patterns', 'GPTN_Patterns', 'BRBT_Patterns', 'HYDAN_Patterns', 'SUCC_Patterns', 'BZD_Patterns', 'CBX_Patterns', 'FAD_Patterns', 'OAE_Patterns', 'ACH_Patterns', 'DOPA_Patterns', 'PHEN_Patterns', 'BUTY_Patterns', 'INDOL_Patterns', 'THIOX_Patterns', 'DPBP_Patterns', 'DBZ_Patterns', 'OAP_Patterns', 'H1_RA_Patterns', 'CARB_Patterns', 'AZA_Patterns', 'ALD_Patterns', 'MEL_Patterns', 'OREX_Patterns', 'OHS_Patterns', 'TCA_Patterns', 'SSRI_Patterns', 'ICS_Patterns', 'AAE_Patterns', 'ALKAM_Patterns', 'EDIAM_Patterns', 'PHED_Patterns', 'PIP_Patterns', 'OAH_Patterns')

cate_exist <- intersect(cate_cols, names(hip_poly))
cate_missing <- sapply(hip_poly[cate_exist], function(x) n_distinct(x) == 1)
cate_use <- cate_exist[!cate_missing]
formula_cate_1 <- paste("exitus_readm_outcome ~ Length_of_stay +", paste(cate_use, collapse = " + "))
formula_cate_2 <- paste("refracture_outcome ~ Length_of_stay +", paste(cate_use, collapse = " + "))

cate_exist <- intersect(cate_cols, names(matched_exitus_readm))
cate_missing <- sapply(matched_exitus_readm[cate_exist], function(x) n_distinct(x) == 1)
cate_use <- cate_exist[!cate_missing]
formula_cate_3 <- paste("exitus_readm_outcome ~ Length_of_stay +", paste(cate_use, collapse = " + "))

cate_exist <- intersect(cate_cols, names(matched_refracture))
cate_missing <- sapply(matched_refracture[cate_exist], function(x) n_distinct(x) == 1)
cate_use <- cate_exist[!cate_missing]
formula_cate_4 <- paste("refracture_outcome ~ Length_of_stay +", paste(cate_use, collapse = " + "))


gp_cols <- c('musculo_skeletal_system_Patterns', 'Hypertension_Patterns', 'hormones_hormone_modifiers_Patterns', 'anxiolytics_Patterns', 'antiepileptics_Patterns', 'antihistamines_Patterns', 'Diuretic_Patterns', 'atypical_antipsychotics_Patterns', 'antidepressant_Patterns', 'Angina_pectoris_Patterns', 'hypnotics_and_sedatives_Patterns', 'analgesics_Patterns', 'anti_parkinson_drugs_Patterns', 'Acid_related_disorders_Patterns', 'obstructive_airway_diseases_Patterns', 'typical_antipsychotics_Patterns', 'Diabetes_Patterns', 'anesthetics_Patterns') ###change_0513

gp_exist <- intersect(gp_cols, names(hip_poly))
gp_missing <- sapply(hip_poly[gp_exist], function(x) n_distinct(x) == 1)
gp_use <- gp_exist[!gp_missing]
formula_gp_1 <- paste("exitus_readm_outcome ~ Length_of_stay +", paste(gp_use, collapse = " + "))
formula_gp_2 <- paste("refracture_outcome ~ Length_of_stay +", paste(gp_use, collapse = " + "))

gp_exist <- intersect(gp_cols, names(matched_exitus_readm))
gp_missing <- sapply(matched_exitus_readm[gp_exist], function(x) n_distinct(x) == 1)
gp_use <- gp_exist[!gp_missing]
formula_gp_3 <- paste("exitus_readm_outcome ~ Length_of_stay +", paste(gp_use, collapse = " + "))

gp_exist <- intersect(gp_cols, names(matched_refracture))
gp_missing <- sapply(matched_refracture[gp_exist], function(x) n_distinct(x) == 1)
gp_use <- gp_exist[!gp_missing]
formula_gp_4 <- paste("refracture_outcome ~ Length_of_stay +", paste(gp_use, collapse = " + "))


risk_cols <- c('Fall_increase_moderate_Patterns', 'Fall_increase_high_Patterns', 'Bone_mass_decrese_high_Patterns', 'Bone_mass_decrese_moderate_Patterns')

risk_exist <- intersect(risk_cols, names(hip_poly))
risk_missing <- sapply(hip_poly[risk_exist], function(x) n_distinct(x) == 1)
risk_use <- risk_exist[!risk_missing]
formula_risk_1 <- paste("exitus_readm_outcome ~ Length_of_stay +", paste(risk_use, collapse = " + "))
formula_risk_2 <- paste("refracture_outcome ~ Length_of_stay +", paste(risk_use, collapse = " + "))

risk_exist <- intersect(risk_cols, names(matched_exitus_readm))
risk_missing <- sapply(matched_exitus_readm[risk_exist], function(x) n_distinct(x) == 1)
risk_use <- risk_exist[!risk_missing]
formula_risk_3 <- paste("exitus_readm_outcome ~ Length_of_stay +", paste(risk_use, collapse = " + "))

risk_exist <- intersect(risk_cols, names(matched_refracture))
risk_missing <- sapply(matched_refracture[risk_exist], function(x) n_distinct(x) == 1)
risk_use <- risk_exist[!risk_missing]
formula_risk_4 <- paste("refracture_outcome ~ Length_of_stay +", paste(risk_use, collapse = " + "))

# construct Model Cohorts by burden level
Poly_exre_high <- matched_exitus_readm[matched_exitus_readm$Burden_of_Med_Pre == 'High', ]
Poly_exre_mid <- matched_exitus_readm[matched_exitus_readm$Burden_of_Med_Pre == 'Mid', ]
Poly_exre_low <- matched_exitus_readm[matched_exitus_readm$Burden_of_Med_Pre == 'Low', ]

Poly_refr_high <- matched_refracture[matched_refracture$Burden_of_Med_Pre == 'High', ]###change_0514
Poly_refr_mid <- matched_refracture[matched_refracture$Burden_of_Med_Pre == 'Mid', ]###change_0514
Poly_refr_low <- matched_refracture[matched_refracture$Burden_of_Med_Pre == 'Low', ]###change_0514

###change_0512
# Function to conditionally run glm if data is not empty
glm_notnull <- function(formula, data, family) {
  if (nrow(data) == 0) {
    cat("The dataset is empty. Skipping glm.\n")
    return(NULL)
  }
...
# Model m1_1a: outcome 1, by Risk, nearest match 
m1_1a = glm(as.formula(formula_risk_3), family = binomial(link = "logit"), data = matched_exitus_readm) 
summary(m1_1a)

m1_1a_high = glm_notnull(as.formula(formula_risk_3), family = binomial(link = "logit"), data = Poly_exre_high) # model by burden level ###change_0512
m1_1a_mid = glm_notnull(as.formula(formula_risk_3), family = binomial(link = "logit"), data = Poly_exre_mid)   # model by burden level ###change_0512
m1_1a_low = glm_notnull(as.formula(formula_risk_3), family = binomial(link = "logit"), data = Poly_exre_low)   # model by burden level ###change_0512

# Model m1_1b: outcome 1, by Risk, no match
m1_1b = glm(as.formula(formula_risk_1), family = binomial(link = "logit"), data = hip_poly)
summary(m1_1b)

# Model m1_2a: outcome 1, by Grandparent, nearest match 
m1_2a = glm(as.formula(formula_gp_3), family = binomial(link = "logit"), data = matched_exitus_readm)
summary(m1_2a)

m1_2a_high = glm_notnull(as.formula(formula_gp_3), family = binomial(link = "logit"), data = Poly_exre_high) ###change_0512
m1_2a_mid = glm_notnull(as.formula(formula_gp_3), family = binomial(link = "logit"), data = Poly_exre_mid) ###change_0512
m1_2a_low = glm_notnull(as.formula(formula_gp_3), family = binomial(link = "logit"), data = Poly_exre_low) ###change_0512

# Model m1_2b: outcome 1, by Grandparent, no match 
m1_2b = glm(as.formula(formula_gp_1), family = binomial(link = "logit"), data = hip_poly)
summary(m1_2b)

# Model m1_3a: outcome 1, by Drug Category, nearest match 
m1_3a = glm(as.formula(formula_cate_3), family = binomial(link = "logit"), data = matched_exitus_readm)
summary(m1_3a)

m1_3a_high = glm_notnull(as.formula(formula_cate_3), family = binomial(link = "logit"), data = Poly_exre_high) ###change_0512
m1_3a_mid = glm_notnull(as.formula(formula_cate_3), family = binomial(link = "logit"), data = Poly_exre_mid) ###change_0512
m1_3a_low = glm_notnull(as.formula(formula_cate_3), family = binomial(link = "logit"), data = Poly_exre_low) ###change_0512

# Model m1_3b: outcome 1, by Drug Category, no mathch
m1_3b = glm(as.formula(formula_cate_1), family = binomial(link = "logit"), data = hip_poly)
summary(m1_3b)
...
# Model m2_1a: outcome 1, by Risk, nearest match 
m2_1a = glm(as.formula(formula_risk_4), family = binomial(link = "logit"), data = matched_refracture)   
summary(m2_1a)

m2_1a_high = glm_notnull(as.formula(formula_risk_4), family = binomial(link = "logit"), data = Poly_refr_high)  ###change_0512
m2_1a_mid = glm_notnull(as.formula(formula_risk_4), family = binomial(link = "logit"), data = Poly_refr_mid)  ###change_0512
m2_1a_low = glm_notnull(as.formula(formula_risk_4), family = binomial(link = "logit"), data = Poly_refr_low)  ###change_0512

# Model m2_1b: outcome 1, by Risk, no match
m2_1b = glm(as.formula(formula_risk_2), family = binomial(link = "logit"), data = hip_poly)  
summary(m2_1b)


# Model m2_2a: outcome 1, by Grandparent, nearest match 

m2_2a = glm(as.formula(formula_gp_4), family = binomial(link = "logit"), data = matched_refracture)
summary(m2_2a)

m2_2a_high = glm_notnull(as.formula(formula_gp_4), family = binomial(link = "logit"), data = Poly_refr_high)  ###change_0512
m2_2a_mid = glm_notnull(as.formula(formula_gp_4), family = binomial(link = "logit"), data = Poly_refr_mid)  ###change_0512
m2_2a_low = glm_notnull(as.formula(formula_gp_4), family = binomial(link = "logit"), data = Poly_refr_low)  ###change_0512

# Model m2_2b: outcome 1, by Grandparent, no match 


m2_2b =glm(as.formula(formula_gp_2), family = binomial(link = "logit"), data = hip_poly)
summary(m2_2b)

# Model m2_3a: outcome 1, by Drug Category, nearest match 


m2_3a = glm(as.formula(formula_cate_4), family = binomial(link = "logit"), data = matched_refracture)
summary(m2_3a)

m2_3a_high = glm_notnull(as.formula(formula_cate_4), family = binomial(link = "logit"), data = Poly_refr_high)  ###change_0512
m2_3a_mid = glm_notnull(as.formula(formula_cate_4), family = binomial(link = "logit"), data = Poly_refr_mid)  ###change_0512
m2_3a_low = glm_notnull(as.formula(formula_cate_4), family = binomial(link = "logit"), data = Poly_refr_low)  ###change_0512

# Model m2_3b: outcome 1, by Drug Category, no match

m2_3b = glm(as.formula(formula_cate_2), family = binomial(link = "logit"), data = hip_poly)
summary(m2_3b)
...
```{r result_saving_model_2, echo=FALSE, warning=FALSE}
###change_0512
extract_model_info_2 <- function(model) {
  
  if (is.null(model)) {
  cat("Provided model is NULL. Returning NULL.\n")
  return(NULL)
  }
...
outcome_1_list_poly <- list(m1_1a_high, m1_1a_mid, m1_1a_low, m1_2a_high, m1_2a_mid, m1_2a_low, m1_3a_high, m1_3a_mid, m1_3a_low)
outcome_2_list_poly <- list(m2_1a_high, m2_1a_mid, m2_1a_low, m2_2a_high, m2_2a_mid, m2_2a_low, m2_3a_high, m2_3a_mid, m2_3a_low)


#output_folder <- "../../outputs" # dir_flag

for (i in 1:length(outcome_1_list_poly)) {
  output_name_txt <- file.path(output_folder, paste0("model_poly_summary_1_", i, ".txt"))
  
  model_info <- extract_model_info_2(outcome_1_list_poly[[i]])
  # Write Summary

  if (is.null(model_info)) {
    writeLines("Model information is NULL.", output_name_txt)
  } else {
    # Write Summary
    writeLines(model_info$summary, output_name_txt)
  }

}

for (i in 1:length(outcome_2_list_poly)) {
  output_name_txt <- file.path(output_folder, paste0("model_poly_summary_2_", i, ".txt"))
  
  model_info <- extract_model_info_2(outcome_2_list_poly[[i]])
  # Write Summary
