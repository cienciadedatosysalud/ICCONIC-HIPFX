...
m1_1a = glm(as.formula(formula_risk_1), family = binomial(link = "logit"), data = matched_exitus_readm) 
summary(m1_1a)

m1_1a_high = glm_notnull(as.formula(formula_risk_1), family = binomial(link = "logit"), data = Poly_exre_high) # model by burden level ###change_0512
m1_1a_mid = glm_notnull(as.formula(formula_risk_1), family = binomial(link = "logit"), data = Poly_exre_mid)   # model by burden level ###change_0512
m1_1a_low = glm_notnull(as.formula(formula_risk_1), family = binomial(link = "logit"), data = Poly_exre_low)   # model by burden level ###change_0512
...
m1_2a = glm(as.formula(formula_gp_1), family = binomial(link = "logit"), data = matched_exitus_readm)
summary(m1_2a)

m1_2a_high = glm_notnull(as.formula(formula_gp_1), family = binomial(link = "logit"), data = Poly_exre_high) ###change_0512
m1_2a_mid = glm_notnull(as.formula(formula_gp_1), family = binomial(link = "logit"), data = Poly_exre_mid) ###change_0512
m1_2a_low = glm_notnull(as.formula(formula_gp_1), family = binomial(link = "logit"), data = Poly_exre_low) ###change_0512
...
m1_3a = glm(as.formula(formula_cate_1), family = binomial(link = "logit"), data = matched_exitus_readm)
summary(m1_3a)

m1_3a_high = glm_notnull(as.formula(formula_cate_1), family = binomial(link = "logit"), data = Poly_exre_high) ###change_0512
m1_3a_mid = glm_notnull(as.formula(formula_cate_1), family = binomial(link = "logit"), data = Poly_exre_mid) ###change_0512
m1_3a_low = glm_notnull(as.formula(formula_cate_1), family = binomial(link = "logit"), data = Poly_exre_low) ###change_0512
...
m2_1a = glm(as.formula(formula_risk_2), family = binomial(link = "logit"), data = matched_refracture)   
summary(m2_1a)

m2_1a_high = glm_notnull(as.formula(formula_risk_2), family = binomial(link = "logit"), data = Poly_refr_high)  ###change_0512
m2_1a_mid = glm_notnull(as.formula(formula_risk_2), family = binomial(link = "logit"), data = Poly_refr_mid)  ###change_0512
m2_1a_low = glm_notnull(as.formula(formula_risk_2), family = binomial(link = "logit"), data = Poly_refr_low)  ###change_0512
...
m2_2a = glm(as.formula(formula_gp_2), family = binomial(link = "logit"), data = matched_refracture)
summary(m2_2a)

m2_2a_high = glm_notnull(as.formula(formula_gp_2), family = binomial(link = "logit"), data = Poly_refr_high)  ###change_0512
m2_2a_mid = glm_notnull(as.formula(formula_gp_2), family = binomial(link = "logit"), data = Poly_refr_mid)  ###change_0512
m2_2a_low = glm_notnull(as.formula(formula_gp_2), family = binomial(link = "logit"), data = Poly_refr_low)  ###change_0512
...
####### END UPDATE IACS (0513) #####

m2_3a = glm(as.formula(formula_cate_2), family = binomial(link = "logit"), data = matched_refracture)
summary(m2_3a)

m2_3a_high = glm_notnull(as.formula(formula_cate_2), family = binomial(link = "logit"), data = Poly_refr_high)  ###change_0512
m2_3a_mid = glm_notnull(as.formula(formula_cate_2), family = binomial(link = "logit"), data = Poly_refr_mid)  ###change_0512
m2_3a_low = glm_notnull(as.formula(formula_cate_2), family = binomial(link = "logit"), data = Poly_refr_low)  ###change_0512
