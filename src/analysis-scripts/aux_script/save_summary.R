sink("../../outputs/summary_GAMM_exitus_inhospital.txt")
...
sink("../../outputs/summary_GAMM_exitus_7days.txt")
...
sink("../../outputs/summary_GAMM_exitus_30days.txt")
...
sink("../../outputs/summary_GAMM_unplanned_7days.txt")
...
sink("../../outputs/summary_GAMM_unplanned_30days.txt")
